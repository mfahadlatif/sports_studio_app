...
class ContactPage extends StatelessWidget {
  ...
  Widget _buildContactInfo({required IconData icon, required String title, required String info}) {
    return Container(
      padding: const EdgeInsets.all(AppSpacing.m),
      decoration: BoxDecoration(
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(info, style: AppTextStyles.bodyMedium.copyWith(color: AppColors.textPrimary)),
            ],
          ),
        ],
      ),
